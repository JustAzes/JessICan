...
schreibt static/img/carus-icon.svg, carus-icon-180.png und carus-share.png
...
BG = (5, 7, 11)
ICON_SVG = 'static/img/carus-icon.svg'
ICON_PNG = 'static/img/carus-icon-180.png'
SHARE = 'static/img/carus-share.png'
